...
install_apt_deps(){
  ...
  sudo apt-get update
  sudo apt-get install -y git make gcc g++ libssl-dev cmake libnice10 libnice-dev libglib2.0-dev pkg-config nodejs libboost-regex-dev libboost-thread-dev libboost-system-dev liblog4cxx10-dev openjdk-6-jre curl
